...
aws ec2 create-key-pair --key-name flask-ml-api-key --query 'KeyMaterial' --output text > flask-ml-api-key.pem

# Set proper permissions
chmod 400 flask-ml-api-key.pem
```
...
```bash
KEY_PAIR_NAME="flask-ml-api-key"  # Your key pair name
